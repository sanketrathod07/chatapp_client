...
const EditUserDetails = ({ onClose, user }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        // Create a clean object with only the properties you need to send
        const cleanData = {
            name: data.name,
        ...
        try {
            ...
            const response = await axios({
                method: 'post',
                url: URL,
                data: cleanData, // Send only serializable data
            ...
            <div className='bg-white p-4 py-6 m-1 rounded w-full max-w-sm'>
                ...
                <form className='grid gap-3 mt-3' onSubmit={handleSubmit}>
                    ...
                    <div>
                        ...
                        {/* Show loading component when image is being uploaded */}
                        {loading && <Loading />}
                    </div>
